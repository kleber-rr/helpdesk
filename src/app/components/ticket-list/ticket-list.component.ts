...
export class TicketListComponent implements OnInit {
  ...
  filter(): void {
    ...
    this.ticketService.findByParams(this.page, this.count, this.assignedToMe, this.ticketFilter)
      .subscribe((response: ResponseApi) => {
        ...
        this.ticketFilter.numero = this.ticketFilter.numero == null ? 0 : this.ticketFilter.numero;
        this.listTicket = response['data']['content'];
  ...
  delete(id:string){
    this.dialogService.confirm('Do you want to delete this ticket?')
